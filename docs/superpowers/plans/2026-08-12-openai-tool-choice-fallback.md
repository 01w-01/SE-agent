...
- [x] **Step 1: 写入 required 400 后同轮 tools-only 成功的失败测试**
...
- [x] **Step 2: 写入实例记忆、新实例严格模式与非 400 不降级测试**
...
- [x] **Step 3: 写入第二次 400 和恶意状态属性的固定错误测试**
...
- [x] **Step 2: 用真实 CLI 修复一次性 clamp 项目**
